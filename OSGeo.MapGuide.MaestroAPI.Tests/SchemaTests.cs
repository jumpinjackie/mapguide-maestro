...
namespace OSGeo.MapGuide.MaestroAPI.Tests
{
    public class SchemaTests
    {
        ...
        public void TestFeatureSchemaRoundtrip()
        {
            ...
            Assert.Equal(1, cls.IdentityProperties.Count);
            Assert.Equal(1, cls.Properties.Count);
            Assert.NotNull(prop);
            ...
            schema.AddClass(cls);
            Assert.Equal(1, schema.Classes.Count);
            ...
            Assert.Equal(1, fsd.Schemas.Length);
        ...
        public void TestCreate()
        {
            ...
            Assert.Equal(0, cls.Properties.Count);
            Assert.Equal(0, cls.IdentityProperties.Count);

            var prop = new DataPropertyDefinition("ID", "identity");
            Assert.Equal("ID", prop.Name);
            Assert.Equal("identity", prop.Description);
            Assert.Equal(false, prop.IsAutoGenerated);
            Assert.Equal(false, prop.IsReadOnly);
        ...
        public void TestClassNameEncoding()
        {
            ...
            Assert.Equal(name2, "Abc-x20-def");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = " Abc#defg$$";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x20-Abc-x23-defg-x24--x24-");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = " Abc#defg hij";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x20-Abc-x23-defg-x20-hij");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "--abc-def---ghi--";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x2d--abc-def---ghi--");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "--abc-x20-def-x23--x24-ghi--";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x2d--abc-x2d-x20-def-x2d-x23--x2d-x24-ghi--");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "-xab";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x2d-xab");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "&Entity";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x26-Entity");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "11ab";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x31-1ab");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "2_Class";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x32-_Class");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "2%Class";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x32--x25-Class");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "2-Class";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x32--Class");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "2-x2f-Class";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x32--x2d-x2f-Class");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "_x2d-";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x00-_x2d-");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "-x3d-";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x2d-x3d-");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "_x2d-_x3f-";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x00-_x2d-_x3f-");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "__x2d-_x3f-";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "__x2d-_x3f-");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "_Class";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_Class");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "_5Class";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_5Class");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "_-5Class";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_-5Class");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "-_x2f-Class";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "_x2d-_x2f-Class");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            name1 = "Foo/Bar - snafu";
            name2 = Utility.EncodeFDOName(name1);
            Assert.Equal(name2, "Foo-x2f-Bar-x20---x20-snafu");
            Assert.Equal(name1, Utility.DecodeFDOName(name2));

            // Backward compatibility check. Make sure old-style 1st character encodings get decoded.
            name2 = "-x40-A";
            Assert.Equal(Utility.DecodeFDOName(name2), "@A");
        }
    }
}
