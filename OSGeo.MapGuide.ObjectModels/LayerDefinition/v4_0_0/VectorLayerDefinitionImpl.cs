...
#elif LDF_130 || LDF_230 || LDF_240 || LDF_400
...
#if LDF_130 || LDF_230 || LDF_240 || LDF_400
, IAreaVectorStyle2
#endif
    {
        [XmlIgnore]
...
, ILineVectorStyle2
    ...
    abstract partial class SymbolType : ISymbol
    {
        ...
        string ISymbol.InsertionPointY
        {
            get
            {
                return this.InsertionPointY;
            }
            set
            {
                this.InsertionPointY = value;
            }
        }
    }
...
#elif LDF_400
        private static readonly Version RES_VERSION = new Version(4, 0, 0);
#else
...
#elif LDF_400
            get { return "LayerDefinition-4.0.0.xsd"; } //NOXLATE
#else
