...
namespace OSGeo.MapGuide.ObjectModels.RuntimeMap.v4_0_0
{
    ...
    public partial class RuntimeMap : System.ComponentModel.INotifyPropertyChanged {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        private string tileSetProviderField;
        
        [EditorBrowsable(EditorBrowsableState.Never)]
        private string tileFormatField;
        
        [EditorBrowsable(EditorBrowsableState.Never)]
        private int tilePixelRatioField;
        ...
        /// </summary>
        public string TileSetProvider
        {
            get
            {
                return this.tileSetProviderField;
            }
            set
            {
                if ((this.tileSetProviderField != null))
                {
                    if ((tileSetProviderField.Equals(value) != true))
                    {
                        this.tileSetProviderField = value;
                        this.OnPropertyChanged("TileSetProvider");
                    }
                }
                else
                {
        ...
        public string TileFormat
        {
            ...
            set
            {
                if ((this.tileFormatField != null))
                {
                    if ((tileFormatField.Equals(value) != true))
                    {
                        this.tileFormatField = value;
                        this.OnPropertyChanged("TileFormat");
                    }
                }
                else
                {
        ...
        public int TilePixelRatio
        {
            get
            {
                return this.tilePixelRatioField;
            }
            set
            {
                if ((tilePixelRatioField.Equals(value) != true))
                {
                    this.tilePixelRatioField = value;
                    this.OnPropertyChanged("TilePixelRatio");
                }
            }
        }
