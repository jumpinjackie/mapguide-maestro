...
namespace OSGeo.MapGuide.Maestro.ResourceEditors
{
	...
	public class FeatureSourceEditorSHP : System.Windows.Forms.UserControl, ResourceEditor
	{
		...
		private ResourceEditors.FeatureSourceEditors.SHP.Unmanaged unmanaged;
		private ResourceEditors.FeatureSourceEditors.SHP.Managed managed;
		private System.Windows.Forms.Panel providerpanel;
		private bool m_isUpdating = false;
		private Globalizator.Globalizator m_globalizor;

		public FeatureSourceEditorSHP()
		{
			...
			string tmp = m_globalizor.Translate("OSGeo.MapGuide.Maestro.ResourceEditors.FeatureSourceEditorSHP.FilePathType.Items");
		...
		private void InitializeComponent()
		{
			...
			this.managed = new ResourceEditors.FeatureSourceEditors.SHP.Managed();
			this.unmanaged = new ResourceEditors.FeatureSourceEditors.SHP.Unmanaged();
		...
		public void UpdateDisplay()
		{
			try
			{
				...
				if (m_feature.Parameter["DefaultFileLocation"] == null || m_feature.Parameter["DefaultFileLocation"].Trim().Length == 0 || m_feature.Parameter["DefaultFileLocation"].IndexOf("%MG_DATA_FILE_PATH%") >= 0)
