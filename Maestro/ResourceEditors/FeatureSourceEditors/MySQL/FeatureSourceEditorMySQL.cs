...
namespace OSGeo.MapGuide.Maestro.ResourceEditors
{
	...
	/// </summary>
	public class FeatureSourceEditorMySQL : System.Windows.Forms.UserControl, ResourceEditor
	{
		...
		public FeatureSourceEditorMySQL()
		{
			...
			toolTips.SetToolTip(Port, m_globalizor.Translate("Enter communication port here, or leave blank for the default, which is 3306"));
		}
		...
		public void UpdateDisplay()
		{
			try
			{
				...
				// - database - use default localhost and port ()
