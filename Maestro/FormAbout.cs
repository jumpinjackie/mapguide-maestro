...
namespace OSGeo.MapGuide.Maestro
{
	...
	public class FormAbout : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.linkLabel.Text = "http://code.google.com/p/mapstudioos/";
			...
			this.License.Text = @"Copyright (C) 2006, Kenneth Skovhede
http://www.hexad.dk, opensource@hexad.dk
...
Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston, MA  02110-1301  USA";
			...
			this.Credits.Text = "Programming:\r\n  Kenneth Skovhede, Hexad\r\nArtwork:\r\n  Kenneth Skovhede, Hexad\r\nEng" +
				...
				" José Manuel Cerrejón González, MAPAS SL";
			// 
			// FormAbout
			// 
		...
		{
			OpenUrl("https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=paypal%40hexad%2edk&item_name=Maestro&no_shipping=2&no_note=1&tax=0&currency_code=EUR&lc=DK&bn=PP%2dDonationsBF&charset=UTF%2d8");
		}
		/// <summary>
